		...
		<tr ng-repeat="module in module_list">
			...
			<td class="" ng-if="permission_check.see_module_manage_system_install">
				...
				<div class="link-group" ng-if="do == 'not_installed'">
					...
					<a ng-if="module.cloud_id > 0 && permission_check.see_module_manage_system_shopinfo" ng-href="{{ 'http://bbs.rewlkj.com/module-' + module.cloud_id + '.html' }}" target="_blank" >查看商城详情</a>
					<!-- 安装 end-->
				</div>
				<!-- not_installed end -->
			</td>
